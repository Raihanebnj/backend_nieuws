<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="verjaardag" class="block mt-1 w-full" type="date" name="verjaardag" :value="old('verjaardag')" />
        ...
        <div class="mt-4">
            ...
            <textarea id="over_mij" class="block mt-1 w-full" name="over_mij" rows="4">{{ old('over_mij') }}</textarea>
            <x-input-error :messages="$errors->get('over_mij')" class="mt-2" />
        </div>
